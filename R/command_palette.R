...
command_registry <- function() {
  ...
  registry <- register_command(registry, "open_plot_studio", "Open Plot Studio", "Analysis", c("plot", "plots", "plotting", "chart", "charts", "autoplots", "visualization", "theme"), "PS", list(type = "navigate", target = "Plots"))
