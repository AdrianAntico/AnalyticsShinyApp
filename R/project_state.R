...
validate_project_state <- function(project_state, data = NULL) {
  ...
  optional_fields <- c(
    ...
    "active_modeling_context", "source_data_info", "feature_experiment_state", "analytical_campaign_state", "decision_memory_state", "semantic_workspace", "semantic_decision_state", "decision_valuation_state", "decision_workflow_state", "evidence_review_context_state", "causal_intelligence_state", "causal_experiment_state", "causal_completed_experiment_state", "causal_itt_state", "causal_observational_state", "ai_draft_store", "ai_mutation_store", "artifact_relationship_drafts",
